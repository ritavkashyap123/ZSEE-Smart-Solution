...
const Timeline = () => {
  ...
  <div className="ag-format-container">
    <div className="ag-timeline_box">
      ...
      <ul id="ag-timeline-carousel" className="js-timeline-carousel ag-timeline-carousel_list">
        <li>
          <div className="ag-timeline_year">
            2011
          </div>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none">
  <symbol id="ag-arrow-left" viewBox="0 0 7 12">
    <g>
      <path d="M6 0.999512L1 5.99951L6 10.9995" fill="transparent" strokeLinecap="round" strokeLinejoin="round"/>
    </g>
  </symbol>

  <symbol id="ag-arrow-right" viewBox="0 0 7 12">
    <g>
      <path d="M1 10.9995L6 5.99951L1 0.999512" fill="transparent" strokeLinecap="round" strokeLinejoin="round"/>
    </g>
  </symbol>
</svg>
    </div>
